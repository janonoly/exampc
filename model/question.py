...
class PaperList(Base):#用于查看往期考试题目可能不用
    ...
    single_choice_num = Column(Integer, name=u"单选题数", default=0)
    single_choice_score = Column(Integer, name=u"单选分值", default=0)
    judgment = Column(Integer, name=u"判断题数", default=0)
    judgment_score = Column(Integer, name=u"判断分值", default=0)
    multiple_choice_num = Column(Integer, name=u"多选题数", default=0)
    multiple_choice_score = Column(Integer, name=u"多选分值", default=0)
